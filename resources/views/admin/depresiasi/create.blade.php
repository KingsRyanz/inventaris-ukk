...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">
                <i class="fas fa-plus-circle"></i> Tambah Depresiasi
            </h4>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.depresiasi.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('lama_depresiasi') is-invalid @enderror" id="lama_depresiasi" name="lama_depresiasi" value="{{ old('lama_depresiasi') }}" required>
